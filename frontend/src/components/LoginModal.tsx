      ...
      >
        ...
        <div className="bg-surface-container-lowest rounded-3xl shadow-2xl overflow-hidden flex flex-col relative">
          ...
          <div className="px-xl pt-12 pb-6 text-center relative z-10">
            <h1 className="text-[26px] font-extrabold text-slate-900 tracking-tight mb-xs">Sign in to your account</h1>
          </div>
          ...
          <div className="px-xl pb-xl relative z-10 space-y-3">
            <button type="button" onClick={() => handleSocialSignIn('google')} disabled={isLoading} className="w-full bg-white border border-slate-200 hover:bg-slate-50 transition-colors py-3 px-4 rounded-full flex items-center justify-center gap-3 font-semibold text-sm text-slate-700 shadow-sm cursor-pointer active:scale-[0.98] disabled:opacity-50">
            ...
            <button type="button" onClick={() => handleSocialSignIn('apple')} disabled={isLoading} className="w-full bg-slate-900 border border-slate-900 hover:bg-slate-800 transition-colors py-3 px-4 rounded-full flex items-center justify-center gap-3 font-semibold text-sm text-white shadow-sm cursor-pointer active:scale-[0.98] disabled:opacity-50">
              Continue with Apple
            </button>
          </div>
