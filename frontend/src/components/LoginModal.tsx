          ...
          <form onSubmit={handleSubmit} className="px-xl pb-6 space-y-lg relative z-10">
            ...
            <div className="space-y-xs">
              <div className="flex justify-between items-center">
                ...
                <button type="button" className="font-label-caps text-label-caps text-slate-400 hover:text-primary transition-colors duration-300 cursor-pointer">Forgot Password?</button>
              </div>
